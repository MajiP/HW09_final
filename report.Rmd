...
4) Next I use linfit_filtered.tsv and **plots.R** to plot the change in life expectancy with gdp per capita for each continent and save the plots to file. Here's an example plot for Asia. 
![](Asia_gdp_life.png)
